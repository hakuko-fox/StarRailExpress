...
public class TMMRoles {
    ...
    public static final SRERole DISCOVERY_CIVILIAN = registerRole(
            new NormalRole(SRE.id("discovery_civilian"), 0x5CFF4A, false, false, SRERole.MoodType.NONE, -1, true)).setCanPickUpRevolver(false).setCanUseKiller(true).setNeutrals(true).setNeutralForKiller(false);
