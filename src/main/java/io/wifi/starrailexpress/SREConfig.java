...
public class SREConfig implements ConfigData {
    ...
    // DNF 地图点位配置。默认不覆盖旧存档中的 CCA 点位；使用 /tmm:dnf config set 后会自动启用并保存。
    @ConfigEntry.Category(value = "dnf_world")
    public boolean dnfUseConfiguredFoodBoxPos = false;
    @ConfigEntry.Category(value = "dnf_world")
    public int dnfFoodBoxX = 0;
    @ConfigEntry.Category(value = "dnf_world")
    public int dnfFoodBoxY = 64;
    @ConfigEntry.Category(value = "dnf_world")
    public int dnfFoodBoxZ = 0;
    @ConfigEntry.Category(value = "dnf_world")
    public boolean dnfUseConfiguredWaterSourcePos = false;
    @ConfigEntry.Category(value = "dnf_world")
    public int dnfWaterSourceX = 0;
    @ConfigEntry.Category(value = "dnf_world")
    public int dnfWaterSourceY = 64;
    @ConfigEntry.Category(value = "dnf_world")
    public int dnfWaterSourceZ = 0;
    @ConfigEntry.Category(value = "dnf_world")
    public boolean dnfUseConfiguredMeteorPos = false;
    @ConfigEntry.Category(value = "dnf_world")
    public int dnfMeteorX = 0;
    @ConfigEntry.Category(value = "dnf_world")
    public int dnfMeteorY = 64;
    @ConfigEntry.Category(value = "dnf_world")
    public int dnfMeteorZ = 0;
    @ConfigEntry.Category(value = "dnf_world")
    public boolean dnfUseConfiguredWallHolePos = false;
    @ConfigEntry.Category(value = "dnf_world")
    public int dnfWallHoleX = 0;
    @ConfigEntry.Category(value = "dnf_world")
    public int dnfWallHoleY = 64;
    @ConfigEntry.Category(value = "dnf_world")
    public int dnfWallHoleZ = 0;
    @ConfigEntry.Category(value = "dnf_world")
    public boolean dnfUseConfiguredOldChefDiaryPos = false;
    @ConfigEntry.Category(value = "dnf_world")
    public int dnfOldChefDiaryX = 0;
    @ConfigEntry.Category(value = "dnf_world")
    public int dnfOldChefDiaryY = 64;
    @ConfigEntry.Category(value = "dnf_world")
    public int dnfOldChefDiaryZ = 0;
    @ConfigEntry.Category(value = "dnf_world")
    public boolean dnfUseConfiguredCafeteriaArea = false;
    @ConfigEntry.Category(value = "dnf_world")
    public double dnfCafeteriaMinX = 0.0;
    @ConfigEntry.Category(value = "dnf_world")
    public double dnfCafeteriaMinY = 0.0;
    @ConfigEntry.Category(value = "dnf_world")
    public double dnfCafeteriaMinZ = 0.0;
    @ConfigEntry.Category(value = "dnf_world")
    public double dnfCafeteriaMaxX = 0.0;
    @ConfigEntry.Category(value = "dnf_world")
    public double dnfCafeteriaMaxY = 0.0;
    @ConfigEntry.Category(value = "dnf_world")
    public double dnfCafeteriaMaxZ = 0.0;
    ...
    @ConfigEntry.Category(value = "underworld")
    public int dnfUnderworldReviveSeconds = 180;
    @ConfigEntry.Category(value = "underworld")
    public int dnfUnderworldAttackTimeReductionSeconds = 30;
    @ConfigEntry.Category(value = "underworld")
    public int dnfUnderworldWaitingRoomHalfSize = 5;
    @ConfigEntry.Category(value = "underworld")
    public int dnfUnderworldWaitingRoomHeight = 5;
    @ConfigEntry.Category(value = "underworld")
    public int dnfUnderworldWaitingRoomSpacing = 32;
    @ConfigEntry.Category(value = "underworld")
    public int dnfUnderworldWaitingRoomBaseOffsetX = 96;
    @ConfigEntry.Category(value = "underworld")
    public int dnfUnderworldWaitingRoomBaseOffsetY = 24;
    @ConfigEntry.Category(value = "underworld")
    public int dnfUnderworldWaitingRoomBaseOffsetZ = 96;
