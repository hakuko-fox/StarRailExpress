...
public class SRECustomRoleWorldComponent implements AutoSyncedComponent {
    public static final ComponentKey<SRECustomRoleWorldComponent> KEY = ComponentRegistry.getOrCreate(SRE.id("custom_roles"),
            SRECustomRoleWorldComponent.class);
    private final Level world;
    HashMap<String, SRERole> pathToRole = new HashMap<>();

    private final HashMap<UUID, SRERole> roles = new HashMap<>();

    public SRECustomRoleWorldComponent(Level world) {
        this.world = world;
    }
