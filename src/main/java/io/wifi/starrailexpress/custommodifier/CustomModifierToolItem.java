...
/**
 * 自定义修饰符工具（右键打开编辑界面），与 {@code CustomRoleToolItem} 一致。
 */
public class CustomModifierToolItem extends Item {

    public static Predicate<Player> openScreenCallback = null;

    public CustomModifierToolItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack itemStack, TooltipContext tooltipContext, List<Component> list,
        ...
        list.add(Component.translatable("item.starrailexpress.custom_modifier_tool.tooltip"));
    }
}
