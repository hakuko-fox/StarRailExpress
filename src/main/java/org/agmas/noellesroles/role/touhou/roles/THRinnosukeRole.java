 ...
 * THRinnosukeRole
 */
public class THRinnosukeRole extends TouhouRole implements CustomWinnerRoleInterface {
    ...
    static {
        ...
        // 护盾
        SHOP.add(new ShopEntry(TMMItems.DEFENSE_VIAL.getDefaultInstance(), 400, ShopEntry.Type.TOOL));
