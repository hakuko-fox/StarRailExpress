...
public class WaterGhostHud {
    ...
    public static void register() {
        RoleHudRenderCallback.EVENT.register(ModRoles.WATER_GHOST_ID, (guiGraphics, deltaTracker) -> {
            ...
            // 显示干涸死亡倒计时
            int dryDeathRemaining = waterGhostData.get().getDryDeathRemaining();
            ...
            // 显示技能冷却时间
            int cooldownRemaining = waterGhostData.get().getSkillCooldownRemaining();
