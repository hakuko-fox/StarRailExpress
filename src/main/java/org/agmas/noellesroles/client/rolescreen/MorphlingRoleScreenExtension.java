...
public final class MorphlingRoleScreenExtension extends PlayerListRoleScreenExtension<PlayerInfo> {
    ...
    private MorphlingPlayerWidget createMorphlingWidget(LimitedInventoryScreen screen, int x, int y,
            PlayerInfo playerEntity, int index) {
        MorphlingPlayerWidget widget = new MorphlingPlayerWidget(screen, x, y, playerEntity);
