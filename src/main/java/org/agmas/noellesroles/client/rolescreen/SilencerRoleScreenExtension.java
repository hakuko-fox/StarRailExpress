...
public final class SilencerRoleScreenExtension extends PlayerListRoleScreenExtension<PlayerInfo> {
    ...
    private SilencerPlayerWidget createSilencerWidget(LimitedInventoryScreen screen, int x, int y,
            PlayerInfo playerEntity, int index) {
        SilencerPlayerWidget widget = new SilencerPlayerWidget(screen, x, y, playerEntity);
