...
public final class PartyKillerRoleScreenExtension extends PlayerListRoleScreenExtension<PlayerInfo> {
    ...
    private PartyKillerPlayerWidget createPartyKillerWidget(LimitedInventoryScreen screen, int x, int y,
            PlayerInfo playerEntity, int index) {
        PartyKillerPlayerWidget widget = new PartyKillerPlayerWidget(screen, x, y, playerEntity);
