 ...
 * 残月萨马蹄铁 - 召唤残月萨马从天而降。
 */
public class CanyuesaHorseshoeItem extends Item {
    ...
    public CanyuesaHorseshoeItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        CanyuesaHorseEntity horse = new CanyuesaHorseEntity(ModEntities.CANYUESA_HORSE, level);
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("item.noellesroles.canyuesa_horseshoe.tooltip")
