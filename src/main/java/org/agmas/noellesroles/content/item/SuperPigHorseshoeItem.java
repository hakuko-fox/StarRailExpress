 ...
 * 超级猪马蹄铁 - 召唤超级猪马从天而降。
 */
public class SuperPigHorseshoeItem extends Item {
    ...
    public SuperPigHorseshoeItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        SuperPigHorseEntity horse = new SuperPigHorseEntity(ModEntities.SUPER_PIG_HORSE, level);
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("item.noellesroles.super_pig_horseshoe.tooltip")
                .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("item.noellesroles.super_pig_horseshoe.tooltip2")
