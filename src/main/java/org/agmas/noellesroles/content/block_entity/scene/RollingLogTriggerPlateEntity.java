...
/**
 * 滚木触发板方块实体：踩踏触发冷却 + 玩家检测 + 破坏任务激活时周期性召唤滚木。
 */
public class RollingLogTriggerPlateEntity extends BlockEntity {
    ...
    public RollingLogTriggerPlateEntity(BlockPos pos, BlockState state) {
        super(ModSceneBlocks.ROLLING_LOG_TRIGGER_ENTITY, pos, state);
    }
    ...
    public static void serverTick(Level level, BlockPos pos, BlockState state, RollingLogTriggerPlateEntity be) {
