...
public class AlchemistRoleData extends SimpleRoleData {
     ...
     * 构造函数
     */
    public AlchemistRoleData(RoleDataContext context) {
        super(context);
    }
    ...
    public static String getPotionKey(int potionIndex) {
        return switch (potionIndex) {
            case AlchemistRoleData.POTION_ADRENALINE -> "adrenaline";
            case AlchemistRoleData.POTION_ANTIBIOTIC -> "antibiotic";
            case AlchemistRoleData.POTION_HEDINGHONG -> "hedinghong";
            case AlchemistRoleData.POTION_DOGSKIN_PLASTER -> "dogskin_plaster";
            default -> "unknown";
        };
    }
