...
public class WayfarerRoleData extends SimpleRoleData {
    ...
    public WayfarerRoleData(RoleDataContext context) {
        super(context);
    }
    ...
    public static void registerEvents() {
        AfterShieldAllowPlayerDeath.EVENT.register((victim, deathReason) -> {
            ...
            if (gameWorldComponent.isRole(victim, ModRoles.WAYFARER)) {
                ...
                var wayC = RoleData.getNullable(WayfarerRoleData.class, victim);
                if (wayC == null)
                    return true;
                if (wayC.phase == 2) {
        ...
        OnPlayerKilledPlayer.EVENT.register((victim, killer, reason) -> {
            ...
            if (gameWorldComponent.isRole(killer, ModRoles.WAYFARER)) {
                ...
                var wayC = RoleData.getNullable(WayfarerRoleData.class, killer);
                if (!RoleData.isAttached(wayC))
                    return;
                if (wayC.phase == 1) {
